...
class Service
{
    ...
    public static function generateReference($length = 12)
    {
    ...
    public static function convertCurrency($fromCurrency, $toCurrency, $amount, $apiKey) {
        ...
        try {
            ...
            if ($data['result'] == 'success') {
                ...
                if (isset($rates[$toCurrency])) {
                    ...
                    return "Exchange rate for $toCurrency not available.";
                }
            } else {
                return "Failed to fetch exchange rates. Error: " . $data['error'];
            }
